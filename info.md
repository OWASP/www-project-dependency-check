...
Version 7.3.1
* [Command Line](https://github.com/jeremylong/DependencyCheck/releases/download/v7.3.1/dependency-check-7.3.1-release.zip)
* [Ant Task](https://github.com/jeremylong/DependencyCheck/releases/download/v7.3.1/dependency-check-ant-7.3.1-release.zip)
* [Maven Plugin](https://search.maven.org/#artifactdetails%7Corg.owasp%7Cdependency-check-maven%7C7.3.1%7Cmaven-plugin)
* [Gradle Plugin](https://search.maven.org/#artifactdetails%7Corg.owasp%7Cdependency-check-gradle%7C7.3.1%7Cgradle-plugin)
